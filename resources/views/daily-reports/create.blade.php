                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('daily-reports.store') }}">
                        ...
                        <div>
                            ...
                            <x-text-input id="report_date" class="block mt-1 w-full bg-gray-100" type="text" name="report_date" :value="jdate()->format('Y/m/d')" readonly />
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="variable_tasks" name="variable_tasks" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('variable_tasks') }}</textarea>
